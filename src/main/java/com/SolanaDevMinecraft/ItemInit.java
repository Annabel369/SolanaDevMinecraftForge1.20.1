...
public class ItemInit {
    ...
    public static final RegistryObject<Item> BOOT_RELIC = ITEMS.register("boot_relic",
            () -> new ArmorItem(ArmorMaterials.NETHERITE, Type.BOOTS, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> LEG_RELIC = ITEMS.register("leg_relic",
            () -> new ArmorItem(ArmorMaterials.NETHERITE, Type.LEGGINGS, new Item.Properties().fireResistant().rarity(Rarity.EPIC)));
}
