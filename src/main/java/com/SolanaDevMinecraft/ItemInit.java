...
public class ItemInit {
    ...
    public static final RegistryObject<Item> NETHER_RELIC = ITEMS.register("nether_relic",
            () -> new ArmorItem(ArmorMaterials.GOLD, ArmorItem.Type.HELMET, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> BOOT_RELIC = ITEMS.register("boot_relic",
            () -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorItem.Type.BOOTS, new Item.Properties().fireResistant()));
    ...
    public static final RegistryObject<Item> LEG_RELIC = ITEMS.register("leg_relic",
            () -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorItem.Type.LEGGINGS, new Item.Properties().fireResistant().rarity(Rarity.EPIC)));
}
